/**
 * Az alábbi program bekéri egy négyzetrácsos pályán egy játékos jelenlegi helyzetét, valamint a célt,
 * ahova el kell jutnia. Egészítsd ki a programot, hogy megjelenítse a játékos mozgásait!
 * A játékos a következő szabályok szerint mozog:
 * Először függőlegesen elmegy abba a sorba, ahol a cél va
 * Majd vízszintesen elmegy a céli
 * Mind a játékos, mind a cél esetében az első adat (jatekosX, celX) az x pozíciót adja meg, vagyis hogy vízszintesen hol van.
 * Ez balról jobbra növekszik. A második adat (jatekosY, celY) az y pozíciót, vagyis a sort tárolja. Ez lentről felfelé növekszik.
