...
public class ApplicationMain {
    ...
    static void kisebbAtlag(Szamsor s1, Szamsor s2) {
        double atlag1 = s1.atlag();
        double atlag2 = s2.atlag();

        if (atlag1 > atlag2) {
            System.out.println("Az s1 átlag a nagyobb");
        } else if (atlag1 < atlag2) {
            System.out.println("Az s2 átlag a nagyobb");
        } else {
            System.out.println("Az s1 és az s2 egyenlő");
        }
    }
